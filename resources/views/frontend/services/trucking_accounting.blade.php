            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image_40.webp') }}" alt="26ft Box Truck" class="truck-photo" loading="lazy">
                    </picture>
                </div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        ...
                        <img src="{{ asset('frontend/assets/images/image_60.webp') }}" alt="26ft Box Truck on the road" loading="lazy">
                    </picture>
                </div>
            </div>
        </section>
