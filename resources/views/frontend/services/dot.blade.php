...
@section('title', 'DOT Compliance Services - CoreTech Dispatch')
@section('main-content')


    <div class="page-wrapper">
        <section class="header-section">
            <h1 class="main-heading">DOT Compliance Services</h1>
            <div class="content-box">
                <div class="truck-photo-container">
                    <div class="photo-decoration"></div>
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image_28 (1).webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image_28 (1).webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image_28 (1).webp') }}" alt="26ft Box Truck" class="truck-photo"
                            loading="lazy">
                    </picture>
                </div>
                ...
                <div class="text-content">
                    <p class="service-description1">
                        Meeting DOT requirements is non-negotiable for every truck driver, but the complex rules and
                        constant updates can be overwhelming. At CoreTech, our compliance specialists handle all the
                        details, ensuring you remain fully aligned with the U.S. Department of Transportation’s
                        regulations. Partner with us, and stay focused on driving while we keep you compliant and
                        protected.
                    </p>

                    <ul class="benefits-list1">
                        <li><i class="fas fa-check"></i>End-to-end DOT safety and compliance support</li>
                        <li><i class="fas fa-headset"></i>No long-term contracts or hidden fees</li>
                        <li><i class="fas fa-percentage"></i>Personal compliance specialist with 24/7 support</li>
                    </ul>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Stay Safe and Compliant with <span class="logo">CoreTech Dispatch</span> DOT Compliance Services
                </h1>
                <div class="section-desc">
                    DOT safety compliance is critical for every trucking business — mistakes or missed paperwork can
                    mean costly penalties, lost loads, or even being taken off the road. With <span
                        class="logo">CoreTech’s </span>you get a dedicated team to manage every aspect of DOT
                    compliance.We cover a wide range of DOT compliance services U.S. drivers rely on: from driver
                    qualification
                    files to ELD log monitoring and audit preparation.<span class="logo"> CoreTech</span>,helps you stay
                    ahead of DOT compliance rules, avoid violations, and focus on what you do best — driving and growing
                    your business.</div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/image-65.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/image-65.webp') }}" alt="26ft Box Truck on the road" loading="lazy">
                    </picture>
                </div>
            </div>
        </section>
        ...
        <section class="optimize-section animate-section" id="section3">
            ...
            <div class="optimize-grid">
                <div class="optimize-card">
                    <h3>Fast and Reliable DOT Compliance</h3>
                    <p>
                        In trucking, compliance is non-negotiable — and handling DOT requirements shouldn’t slow you
                        down.
                        That’s why CoreTech provides <strong>fast, accurate, and professional DOT compliance
                            support</strong>.
                        From driver qualification files and ELD log monitoring to audit preparation and safety reviews,
                        we make sure every detail is managed without delay.
                    </p>
                    <p>
                        Our experts double-check every file and report to prevent costly violations, failed audits,
                        or unexpected downtime. With CoreTech, you stay focused on the road and your loads —
                        while we handle the compliance that keeps your fleet moving safely and legally.
                    </p>
                </div>

                <div class="optimize-card">
                    <h3>Transparent and Hassle-Free DOT Compliance</h3>
                    <p>
                        At CoreTech, <strong>clarity and accuracy</strong> drive everything we do.
                        Every driver record, inspection report, and safety requirement is tracked and organized
                        for complete visibility — no confusion, no last-minute surprises.
                    </p>
                    <p>
                        We eliminate hidden errors, paperwork stress, and compliance headaches.
                        Instead, we deliver <strong>stress-free DOT compliance management</strong>
                        that keeps your trucking business safe, efficient, and penalty-free.
                    </p>
                </div>
            </div>
        </section>
