            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/image_22_11zon.webp') }}" type="image/webp">
                            <img src="{{ asset('frontend/assets/images/Compressed/image_22_11zon.webp') }}" alt="Truck dispatching"
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1551288049-bebda4e38f71_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1600880292203-757bb62b4baf_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1450101499163-c8848c66ca85_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/image-62_11zon.webp') }}" type="image/webp">
                            <img src="{{ asset('frontend/assets/images/Compressed/image-62_11zon.webp') }}" alt="Document management"
                                class="service-image" loading="lazy">
                        </picture>
                        <div class="service-icon">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1554224155-6726b3ff858f_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1542744173-8e7e53415bb0_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            <source srcset="{{ asset('frontend/assets/images/Compressed/photo-1460925895917-afdab827c52f_11zon.webp') }}"
                                type="image/webp">
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/assets/images/image_39.webp') }}" alt="Promotions services" class="service-image"
                                loading="lazy">
                        </picture>
                        <div class="service-icon">
                            <i class="fas fa-bullhorn"></i>
                ...
                <div class="service-card">
                    <div class="service-image-container image-dark">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/assets/images/image_33.webp') }}" alt="Promotions services" class="service-image"
                                loading="lazy">
                        </picture>
                        <div class="service-icon">
                            <i class="fas fa-bullhorn"></i>
        ...
        <div class="blue-setup-main" id="mainContainer">
            <div class="blue-setup-left" id="leftPanel">
                <div class="blue-setup-info">
                    ...
                    <p id="description">
                        <strong>Dispatch Service</strong> is committed to connecting drivers with the highest-paying
                        loads in the industry, regardless of location or experience level.
                    </p>
