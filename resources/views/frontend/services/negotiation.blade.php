...
@section('title', 'Freight Rate Negotiation Services')
@section('main-content')
    <div class="page-wrapper">
        <section class="header-section">
            <h1 class="main-heading">Freight Rate Negotiation Services</span></h1>
            <div class="content-box">
                <div class="truck-photo-container">
                    <div class="photo-decoration"></div>
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image_29.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image_29.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image_29.webp') }}" alt="26ft Box Truck" class="truck-photo" loading="lazy">
                    </picture>
                </div>

                <div class="text-content">
                    <p class="service-description1">
                        Owner-operators are here to haul freight, not haggle over rates. Let us handle the negotiations
                        for you. Logity Dispatch manages every detail, keeping you free from time-consuming
                        back-and-forths.
                    </p>

                    <ul class="benefits-list1">
                        <li><i class="fas fa-check"></i> Maximize your pay on every load with expert freight negotiation
                        </li>
                        <li><i class="fas fa-headset"></i> Hands-off process for truckers and owner-operators</li>
                        <li><i class="fas fa-percentage"></i> Transparent, performance-based pricing no long-term
                            contracts</li>
                    </ul>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Get the Best Freight Rates Let <span class="logo">CoreTech Dispatch</span> Negotiate for You
                </h1>
                <div class="section-desc">
                    Your time and expertise on the road are priceless. Don’t settle for low-paying loads or waste hours
                    negotiating. <span class="logo">CoreTech’s</span> rate negotiation service ensures you earn more per
                    mile, secure better
                    terms, and connect with top-tier shippers and brokers. </div>

            </div>
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/image-63.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/image-63.webp') }}" alt="26ft Box Truck on the road" loading="lazy">
                    </picture>
                </div>
            </div>
        </section>
        ...
        <section class="optimize-section animate-section" id="section3">
            ...
            <div class="optimize-grid">
                <div class="optimize-card">
                    <h3>Personalized Rate Negotiation Services</h3>
                    <p>CoreTech Dispatch works directly with brokers to negotiate the best possible rates for your freight.
                        We analyze market trends, your equipment type, and preferred lanes to maximize your earnings on
                        every load.
                        Our goal is to ensure you get fair, competitive pricing without sacrificing efficiency or service
                        quality.</p>
                </div>
                <div class="optimize-card">
                    <h3>Transparent and Profitable Load Management</h3>
                    <p>With CoreTech, there are no hidden fees or surprises. Our team tracks detention, lumper, and
                        additional fees
                        so you are fully compensated for your time. We focus on securing top-paying loads that align with
                        your schedule,
                        allowing you to spend more time on the road while boosting your revenue. Start today and let our
                        experts
                        handle your rate negotiations efficiently.</p>
                </div>
            </div>
        </section>
    </div>
