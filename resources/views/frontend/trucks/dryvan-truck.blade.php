...
@section('title', 'Dry Van - CoreTech Dispatch')
@section('main-content')
    ...
    <div class="page-wrapper">
        <section class="header-section">
            ...
            <h1 class="main-heading">Dry Van <span>Dispatch Service</span></h1>
            <p class="sub-heading">Optimize your operations with our specialized dispatch solutions for Dry Van
                trucks
            </p>
            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <source srcset="{{ asset('frontend/assets/images/dry-van-sunset.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/dry-van-sunset.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/dry-van-sunset.webp') }}" alt="26ft Box Truck" class="truck-photo"
                            loading="lazy">
                    </picture>
                </div>
                ...
                <div class="text-content">
                    <p class="service-description1">
                        CoreTech is the trusted partner for truckers seeking reliable and comprehensive dry van dispatch
                        services. Our customer-focused dispatch team takes care of the full range of owner-operator
                        needs. Keep reading to see everything we have to offer!
                    </p>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Pump Up Your Dry Van Trucking Business with <span class="red">CoreTech</span>
                    <span class="blue"> Dispatch</span>
                </h1>
                <div class="section-desc">
                    Hauling dry van freight keeps America moving from consumer goods to industrial supplies. But
                    searching for loads, negotiating rates, and handling paperwork can cut into your profits.

                    That’s where <span class="logo">CoreTech Dispatch</span> comes in. Our dry van dispatch services
                    keep your trucks loaded, operations efficient, and earnings growing while you stay in full
                    control.
                </div>
                <div class="benefits-grid">
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-route"></i></div>
                        <div class="benefit-text">Smart and reliable dry van load planning</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="benefit-text">On-time scheduling for consumer, retail, and industrial freight</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="benefit-text">Boost earnings with high-paying dry van load opportunities</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-headset"></i></div>
                        <div class="benefit-text">24/7 dry van dispatch support for smooth operations</div>
                    </div>
                </div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/dryvan2.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/dryvan2.webp') }}" alt="26ft Box Truck on the road" loading="lazy">
                    </picture>
                </div>
            </div>
        </section>
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                        We don’t settle for just any dry van load we find the ones that best fit your business. Our dispatchers utilize multiple platforms, including exclusive networks not available to most drivers, to secure the most profitable freight opportunities. We negotiate top rates so every mile delivers maximum value. Whether you’re searching for “dry van dispatch services near me” or the best dry van trucking dispatch services in Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
        ...
        <section class="services-section2 animate-section" id="section2">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image-86.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image-86.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-86.webp') }}" alt="Dispatcher in Truck Stop" loading="lazy">
                    </picture>
                </div>
        ...
        <section class="optimize-section animate-section" id="section3">
            <div class="optimize-title">
                Optimize Your Dry Van Truck Operations with <span class="highlight">CoreTech Dispatch</span>
            </div>
