...
@section('title', 'Reefer truck - CoreTech Dispatch')
@section('main-content')
    <div class="page-wrapper">
        <section class="header-section">
            <span class="header-tag">TRUCKER APPROVED</span>
            <h1 class="main-heading">Reefer <span>Dispatch Service</span></h1>
            <p class="sub-heading">Optimize your operations with our specialized dispatch solutions for Reefer
                trucks
            </p>
            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <source srcset="{{ asset('frontend/assets/images/reefeer.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/reefeer.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/reefeer.webp') }}" alt="26ft Box Truck" class="truck-photo" loading="lazy">
                    </picture>
                </div>

                <div class="text-content">
                    <p class="service-description1">
                        Transporting refrigerated goods across the U.S. demands precision, care, and a professional
                        touch. For owner-operators hauling temperature- and time-sensitive freight in reefer trucks, the
                        challenges are just as critical as the cargo itself. That’s where CoreTech Dispatch steps in —
                        we ease the load by providing full support and the right solutions to keep your business running
                        smoothly.
                    </p>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Power Your Refrigerated Freight Business with <span class="red">CoreTech</span>
                    <span class="blue"> Dispatch</span>
                </h1>
                <div class="section-desc">
                    Hauling temperature-sensitive freight means you’re handling some of the most critical loads on the
                    road from fresh produce and frozen foods to pharmaceuticals and other high-value perishables. But
                    securing the best-paying reefer loads, managing strict schedules, and dealing with paperwork can be
                    time-consuming and cut into your profits.
                    At <span class="logo">CoreTech Dispatch</span>, we help you stay ahead. Our specialized reefer
                    dispatch services keep your trucks loaded, your deliveries on time, and your income steady while
                    you stay in control of every haul.
                </div>
                ...
                <div class="benefits-grid">
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">Reliable and efficient reefer route planning</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="benefit-text">On-time scheduling for temperature-sensitive freight</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="benefit-text">Maximize profits with high-paying reefer load matching</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-headset"></i></div>
                        <div class="benefit-text">24/7 reefer dispatch support for seamless operations</div>
                    </div>
                </div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/reefer1.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/reefer1.webp') }}" alt="26ft Box Truck on the road" loading="lazy">
                    </picture>
                </div>
            </div>
        </section>
            ...
            <div class="dispatch-grid1">
                ...
                <div class="dispatch-card1">
                    ...
                    <p class="dispatch-desc1">Our team is available around the clock to resolve issues and keep your
                        reefeer trucks moving efficiently.</p>
                </div>
                <div class="dispatch-card1">
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                        We don’t settle for just any reefer load we find the right ones for your business. Our dispatchers
                        use multiple platforms, including exclusive networks unavailable to most drivers, to secure the most
                        profitable temperature-controlled loads. We negotiate top rates so every mile delivers maximum
                        value. Whether you’re searching for “reefer dispatch services near me” or the best reefer trucking
                        dispatch services in Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
        ...
        <section class="services-section2 animate-section" id="section2">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image-82.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image-82.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-82.webp') }}" alt="Dispatcher in Truck Stop" loading="lazy">
                    </picture>
                </div>
        ...
        <section class="optimize-section animate-section" id="section3">
            <div class="optimize-title">
                Optimize Your Reefer Truck Operations with <span class="highlight">CoreTech Dispatch</span>
            </div>
