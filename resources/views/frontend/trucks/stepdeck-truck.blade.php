...
@section('title', 'Step Deck Truck - CoreTech Dispatch')
@section('main-content')
    ...
    <div class="page-wrapper">
        <section class="header-section">
            ...
            <h1 class="main-heading">Step Deck <span>Dispatch Service</span></h1>
            <p class="sub-heading">Optimize your operations with our specialized dispatch solutions for Step Deck
                trucks
            </p>
            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <source srcset="{{ asset('frontend/assets/images/Step-deck-Trailer.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/Step-deck-Trailer.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/Step-deck-Trailer.webp') }}" alt="26ft Box Truck"
                ...
                <div class="text-content">
                    <p class="service-description1">
                        Reliable step deck dispatch services are becoming harder to find in today’s logistics industry.
                        CoreTech is here to change that offering professional, sustainable, and affordable dispatch
                        solutions designed specifically for owner-operators running step deck trucks.
                    </p>
                    ...
                    <ul class="benefits-list1">
                        ...
                        <li><i class="fas fa-percentage"></i> Only <span class="emphasis-blue">5-6% of gross</span> -
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Pump up Your Step Deck Trucking Business with <span class="red">CoreTech</span>
                    <span class="blue"> Dispatch</span>
                </h1>
                <div class="section-desc">
                    Hauling with a step deck (drop deck) trailer means managing oversized, over-height, and specialized
                    freight that
                    demands precision, expertise, and full compliance.
                    However, spending valuable hours searching for loads, negotiating rates, and handling paperwork can
                    drain your
                    time and limit your earning potential.
                    That’s where <span class="logo">CoreTech Dispatch</span> comes in.
                    Our specialized step deck dispatch services are designed to keep your trucks loaded, your operations
                    compliant,
                    and your profits growing all while you stay in complete control of every haul.
                </div>
                <div class="benefits-grid">
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-route"></i></div>
                        <div class="benefit-text">Reliable and efficient step deck route planning</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="benefit-text">On-time scheduling for oversized and specialized freight</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="benefit-text">Maximize profits with high-paying step deck load matching</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-headset"></i></div>
                        <div class="benefit-text">24/7 step deck dispatch support for hassle-free operations</div>
                    </div>
                </div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/stepdeck1.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/stepdeck1.webp') }}" alt="26ft Box Truck on the road"
                            loading="lazy">
                    </picture>
                </div>
            </div>
        ...
        <section class="dispatch-section1" id="dispatch-section1">
            ...
            <div class="dispatch-grid1">
                ...
                <div class="dispatch-card1">
                    ...
                    <p class="dispatch-desc1">Only 5-6% commission on gross no hidden charges, no upfront payments.
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                        We don’t settle for just any step deck load we find the right ones for your business. Our
                        dispatchers leverage multiple platforms, including exclusive networks not accessible to most
                        drivers, to secure the most profitable oversized and specialized loads. We negotiate top rates
                        so every mile delivers maximum value. Whether you’re searching for “step deck dispatch services
                        near me” or the best step deck trucking dispatch services in Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
        ...
        <section class="services-section2 animate-section" id="section2">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image-73.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image-73.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-73.webp') }}" alt="Dispatcher in Truck Stop"
                            loading="lazy">
                    </picture>
                </div>
        ...
        <section class="optimize-section animate-section" id="section3">
            <div class="optimize-title">
                Optimize Your Step Deck Truck Operations with <span class="highlight">CoreTech Dispatch</span>
            </div>
