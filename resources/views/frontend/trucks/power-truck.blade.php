            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/power-only.webp') }}" alt="26ft Box Truck"
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                        We don’t go after just any power-only load we find the right ones for your business. Our dispatchers
                        use multiple platforms, including exclusive networks unavailable to most drivers, to secure the most
                        profitable loads. We negotiate top rates to make sure every mile pays off. Whether you’re searching
                        for “power-only dispatch services near me” or the best power-only trucking dispatch services in
                        Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-70.webp') }}" alt="Dispatcher in Truck Stop"
                            loading="lazy">
                    </picture>
                </div>
