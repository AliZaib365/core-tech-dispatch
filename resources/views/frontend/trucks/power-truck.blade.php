...
@section('title', 'Power Truck - CoreTech Dispatch')
@section('main-content')

    <div class="page-wrapper">
        <section class="header-section">
            <span class="header-tag">TRUCKER APPROVED</span>
            <h1 class="main-heading">Power Only <span>Dispatch Service</span></h1>
            <p class="sub-heading">Optimize your operations with our specialized dispatch solutions for Power Only
                trucks
            </p>
            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <source srcset="{{ asset('frontend/assets/images/power-only.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/power-only.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/power-only.webp') }}" alt="26ft Box Truck" class="truck-photo"
                            loading="lazy">
                    </picture>
                </div>
                ...
                <div class="text-content">
                    <p class="service-description1">
                        Power-only trucking presents unique challenges that can be tough for owner-operators to manage
                        alone. While it offers great opportunities, it also requires strong professional support. That’s
                        where CoreTech Dispatch steps in. Here’s what you gain when partnering with us:
                    </p>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Accelerate Your Power Only Trucking with <span class="red">CoreTech</span>
                    <span class="blue"> Dispatch</span>
                </h1>
                <div class="section-desc">
                    Power-only trucking gives you control, but finding loads, securing top rates, and handling paperwork
                    can drain time and profits. At <span class="logo">CoreTech Dispatch</span>, we connect
                    owner-operators and fleets with high-paying, reliable loads nationwide managing the details so you
                    can focus on driving and growing your business.
                </div>
                ...
                <div class="benefits-grid">
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">Smart and reliable power-only route planning</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="benefit-text">On-time scheduling for trailers, containers, and equipment moves</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="benefit-text">Maximize earnings with high-paying power-only load matching</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-headset"></i></div>
                        <div class="benefit-text">24/7 power-only dispatch support for seamless operations</div>
                    </div>
                </div>
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/power-only1.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/power-only1.webp') }}" alt="26ft Box Truck on the road"
                            loading="lazy">
                    </picture>
                </div>
            </div>
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                       We don’t go after just any power-only load we find the right ones for your business. Our dispatchers use multiple platforms, including exclusive networks unavailable to most drivers, to secure the most profitable loads. We negotiate top rates to make sure every mile pays off. Whether you’re searching for “power-only dispatch services near me” or the best power-only trucking dispatch services in Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
        ...
        <section class="services-section2 animate-section" id="section2">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/image-70.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/image-70.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-70.webp') }}" alt="Dispatcher in Truck Stop" loading="lazy">
                    </picture>
                </div>
        ...
        <section class="optimize-section animate-section" id="section3">
            <div class="optimize-title">
                Optimize Your Power-only Truck Operations with <span class="highlight">CoreTech Dispatch</span>
            </div>
