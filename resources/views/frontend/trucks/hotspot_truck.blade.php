            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <source srcset="{{ asset('frontend/assets/images/hotshot-truck-1024x479-4.webp') }}" type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/hotshot-truck-1024x479-4.webp') }}" type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/hotshot-truck-1024x479-4.webp') }}" alt="26ft Box Truck" class="truck-photo"
                            loading="lazy">
                    </picture>
                </div>
        ...
        <section class="section-container" id="dispatch-section">
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/hotshot-trucking-1-1-3.webp') }}" type="image/webp">
                        <img src="{{ asset('frontend/assets/images/hotshot-trucking-1-1-3.webp') }}" alt="26ft Box Truck on the road"
                            loading="lazy">
                    </picture>
                </div>
            </div>
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-80.webp') }}" alt="Dispatcher in Truck Stop" loading="lazy">
                    </picture>
                </div>
