            ...
            <div class="content-box">
                <div class="truck-photo-container">
                    ...
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/flatbed.webp') }}" alt="26ft Box Truck"
            ...
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        ...
                        <img src="{{ asset('frontend/assets/images/flatbed1.webp') }}" alt="26ft Box Truck on the road"
                            loading="lazy">
                    </picture>
                </div>
            </div>
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        ...
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/image-77.webp') }}" alt="Dispatcher in Truck Stop"
                            loading="lazy">
                    </picture>
                </div>
