...
@section('title', '26ft Box Truck- CoreTech Dispatch')
@section('main-content')
    <div class="page-wrapper">
        <section class="header-section">
            <span class="header-tag">TRUCKER APPROVED</span>
            <h1 class="main-heading">26ft Box Truck <span>Dispatch Services</span></h1>
            <p class="sub-heading">Optimize your operations with our specialized dispatch solutions for 26ft box trucks
            </p>
            ...
            <div class="content-box">
                ...
                <div class="text-content">
                    <p class="service-description1">
                        CoreTech Dispatch provides premium dispatch services designed specifically for 26ft box truck
                        operators. We handle the logistics so you can focus on driving and growing your business.
                    </p>
        ...
        <section class="section-container" id="dispatch-section">
            <div class="section-left">
                <h1 class="section-title">
                    Optimize Your 26ft Box Truck Operations with
                    <span class="red">CoreTech</span>
                    <span class="blue"> Dispatch</span>
                </h1>
                <div class="section-desc">
                    Running a 26ft box truck comes with unique challenges—limited load options, rigid urban delivery
                    requirements, and the need for precise scheduling. At <span class="logo">CoreTech Dispatch</span>,
                    our specialized dispatch services help you overcome these hurdles, maximize profitability, and keep
                    your business moving efficiently.
                </div>
                <div class="benefits-grid">
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-route"></i></div>
                        <div class="benefit-text">Optimal route planning for urban deliveries</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="benefit-text">Precise scheduling to maximize efficiency</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="benefit-text">Increase profitability with better load matching</div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon"><i class="fas fa-headset"></i></div>
                        <div class="benefit-text">24/7 dedicated support for your operations</div>
                    </div>
                </div>
            </div>
            <div class="section-right">
                <div class="image-container">
                    <picture>
                        <source srcset="{{ asset('frontend/assets/images/Compressed/box-truck1_11zon.webp') }}"
                            type="image/webp">
                        <img src="{{ asset('frontend/assets/images/Compressed/box-truck1_11zon.webp') }}"
        ...
        <section class="dispatch-section1" id="dispatch-section1">
            <h1 class="dispatch-header1">
                ...
                for Premium Box Truck Services
            </h1>
            ...
            <div class="service-items1">
                <div class="service-card1">
                    <h3><span class="icon-check1">✓</span> <span class="accent-text1">Load sourcing & rate
                            negotiation</span></h3>
                    <p>
                        We don’t settle for just any box truck load we find the ones that fit your business best. Our
                        dispatchers tap into multiple platforms, including exclusive networks not accessible to most
                        drivers, to secure the most profitable loads. We negotiate top rates to ensure every mile is
                        worth it. Whether you’re searching for “box truck dispatch services near me” or the best box
                        truck dispatch services in Texas, CoreTech has you covered.
                    </p>
                </div>
                <div class="service-card1">
        ...
        <section class="services-section2 animate-section" id="section2">
            ...
            <div class="main-row2">
                <div class="left-img2">
                    <picture>
                        <!-- Modern browsers (WebP) -->
                        <source srcset="{{ asset('frontend/assets/images/Compressed/image-72_11zon_11zon.webp') }}"
                            type="image/webp">
                        <!-- Fallback for older browsers -->
                        <source srcset="{{ asset('frontend/assets/images/Compressed/image-72_11zon_11zon.webp') }}"
                            type="image/jpeg">
                        <!-- Default fallback -->
                        <img src="{{ asset('frontend/assets/images/Compressed/image-72_11zon_11zon.webp') }}"
                            alt="Dispatcher in Truck Stop" loading="lazy">
                    </picture>
                </div>
        ...
        <section class="optimize-section animate-section" id="section3">
            <div class="optimize-title">
                Optimize Your 26ft Box Truck Operations with <span class="highlight">CoreTech Dispatch</span>
            </div>
